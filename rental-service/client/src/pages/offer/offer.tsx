...
function Offer({offers, reviews, offersList}: OfferProps){
  ...
  const ratingWitdh = `${offer.rating * 20}%`;
            ...
            <div className="offer__wrapper">
              ...
              <div className="offer__rating rating">
                <div className="offer__stars rating__stars">
                  <span style={{width: ratingWitdh}}></span>
              ...
              <div className="offer__host">
                ...
                <div className={`offer__avatar-wrapper offer__avatar-wrapper--${offer.host.isPro ? 'pro' : 'normal'} user__avatar-wrapper`}>
